...
// WithAuthorizationToken sets the 'Authorization: Bearer <authorizationToken>' request header.
func WithAuthorizationToken(authorizationToken string) *core.AuthorizationTokenOption {
