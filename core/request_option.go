...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.AuthorizationToken != "" {
		header.Set("Authorization", "Bearer "+r.AuthorizationToken)
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Version", "v3.3.0")
	headers.Set("User-Agent", "github.com/trycourier/courier-go/3.3.0")
	return headers
}
...
// AuthorizationTokenOption implements the RequestOption interface.
type AuthorizationTokenOption struct {
	AuthorizationToken string
}

func (a *AuthorizationTokenOption) applyRequestOptions(opts *RequestOptions) {
	opts.AuthorizationToken = a.AuthorizationToken
}

func (a *AuthorizationTokenOption) applyIdempotentRequestOptions(opts *IdempotentRequestOptions) {
	opts.AuthorizationToken = a.AuthorizationToken
}
