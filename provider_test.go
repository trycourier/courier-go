...
func TestProviderNewWithOptionalParams(t *testing.T) {
...
func TestProviderGet(t *testing.T) {
	...
	_, err := client.Providers.Get(context.TODO(), "id")
	if err != nil {
		var apierr *courier.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestProviderUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestProviderListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Providers.List(context.TODO(), courier.ProviderListParams{
...
func TestProviderDelete(t *testing.T) {
	...
	err := client.Providers.Delete(context.TODO(), "id")
	if err != nil {
		var apierr *courier.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
