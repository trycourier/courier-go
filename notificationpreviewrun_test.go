...
func TestNotificationPreviewRunNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Notifications.Previews.Runs.New(
		...
		courier.NotificationPreviewRunNewParams{
			CreatePreviewRunRequest: courier.CreatePreviewRunRequestParam{
				...
				DeviceSetID:     courier.String("device_set_id"),
				Locale:          courier.String("locale"),
				TemplateVersion: courier.String("draft"),
			},
...
func TestNotificationPreviewRunGet(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Notifications.Previews.Runs.Get(
		context.TODO(),
		"previewRunId",
		courier.NotificationPreviewRunGetParams{
			ID: "id",
		},
	)
	if err != nil {
...
func TestNotificationPreviewRunListWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
