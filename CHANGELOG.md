...
* **api:** document Slack and MS Teams on journey send nodes, and fix over-strict MsTeams tenant requirements [C-20302] ([#164](https://github.com/trycourier/courier-go/issues/164)) ([1ddd38d](https://github.com/trycourier/courier-go/commit/1ddd38d021564f1d297431ab2fd82ac9cc5ba2b0))
...
* **api:** give every request body an example, and correct the archive status code ([#152](https://github.com/trycourier/courier-go/issues/152)) ([822fb64](https://github.com/trycourier/courier-go/commit/822fb646884a1e1e14578fe877388078e119fe0e))
...
* **openapi:** reword Cancel journey runs description (re-trigger deploy) ([98ef901](https://github.com/trycourier/courier-go/commit/98ef901c6b4b4b14796de2c136841344a721f897))
* **openapi:** tighten Journeys cancel/experiment copy (C-19177) ([3fb48d3](https://github.com/trycourier/courier-go/commit/3fb48d3ffc536dd3c14ec4535acdc951390aad7f))
