...
func (l *ListFindByRecipientIdParams) UnmarshalJSON(data []byte) error {
	type unmarshaler ListFindByRecipientIdParams
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*l = ListFindByRecipientIdParams(value)
	l._rawJSON = json.RawMessage(data)
	return nil
}

func (l *ListFindByRecipientIdParams) String() string {
	if len(l._rawJSON) > 0 {
		if value, err := core.StringifyJSON(l._rawJSON); err == nil {
			return value
		}
...
type ListFindByRecipientIdResponse struct {
	Paging  *Paging `json:"paging,omitempty"`
...
func (l *ListFindByRecipientIdResponse) UnmarshalJSON(data []byte) error {
	type unmarshaler ListFindByRecipientIdResponse
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*l = ListFindByRecipientIdResponse(value)
	l._rawJSON = json.RawMessage(data)
	return nil
}

func (l *ListFindByRecipientIdResponse) String() string {
	if len(l._rawJSON) > 0 {
		if value, err := core.StringifyJSON(l._rawJSON); err == nil {
			return value
		}
...
func (l *ListGetAllParams) UnmarshalJSON(data []byte) error {
	type unmarshaler ListGetAllParams
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*l = ListGetAllParams(value)
	l._rawJSON = json.RawMessage(data)
	return nil
}

func (l *ListGetAllParams) String() string {
	if len(l._rawJSON) > 0 {
		if value, err := core.StringifyJSON(l._rawJSON); err == nil {
			return value
		}
...
type ListGetSubscriptionsParams struct {
	Cursor *string `json:"cursor,omitempty"`

	_rawJSON json.RawMessage
}

func (l *ListGetSubscriptionsParams) UnmarshalJSON(data []byte) error {
	type unmarshaler ListGetSubscriptionsParams
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*l = ListGetSubscriptionsParams(value)
	l._rawJSON = json.RawMessage(data)
	return nil
}

func (l *ListGetSubscriptionsParams) String() string {
	if len(l._rawJSON) > 0 {
		if value, err := core.StringifyJSON(l._rawJSON); err == nil {
			return value
		}
...
type RecipientSubscriptionsResponse struct {
	Paging  *Paging `json:"paging,omitempty"`
	Results []*List `json:"results,omitempty"`
...
func (r *RecipientSubscriptionsResponse) UnmarshalJSON(data []byte) error {
	type unmarshaler RecipientSubscriptionsResponse
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*r = RecipientSubscriptionsResponse(value)
	r._rawJSON = json.RawMessage(data)
	return nil
}

func (r *RecipientSubscriptionsResponse) String() string {
	if len(r._rawJSON) > 0 {
		if value, err := core.StringifyJSON(r._rawJSON); err == nil {
			return value
		}
