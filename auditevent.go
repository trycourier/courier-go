...
type AuditEvent struct {
	...
	Actor        AuditEventActor  `json:"actor,nullable"`
	Target       AuditEventTarget `json:"target,nullable"`
...
// Returns the unmodified JSON received from the API
func (r AuditEventTarget) RawJSON() string { return r.JSON.raw }
func (r *AuditEventTarget) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
