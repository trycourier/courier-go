...
- <a href="https://pkg.go.dev/github.com/trycourier/courier-go">courier</a>.<a href="https://pkg.go.dev/github.com/trycourier/courier-go#Preference">Preference</a>
...
- <a href="https://pkg.go.dev/github.com/trycourier/courier-go">courier</a>.<a href="https://pkg.go.dev/github.com/trycourier/courier-go#NotificationContent">NotificationContent</a>
...
- <code title="get /notifications/{id}/content">client.Notifications.<a href="https://pkg.go.dev/github.com/trycourier/courier-go#NotificationService.GetContent">GetContent</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, id <a href="https://pkg.go.dev/builtin#string">string</a>) (<a href="https://pkg.go.dev/github.com/trycourier/courier-go">courier</a>.<a href="https://pkg.go.dev/github.com/trycourier/courier-go#NotificationContent">NotificationContent</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
...
- <code title="get /notifications/{id}/draft/content">client.Notifications.Draft.<a href="https://pkg.go.dev/github.com/trycourier/courier-go#NotificationDraftService.GetContent">GetContent</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, id <a href="https://pkg.go.dev/builtin#string">string</a>) (<a href="https://pkg.go.dev/github.com/trycourier/courier-go">courier</a>.<a href="https://pkg.go.dev/github.com/trycourier/courier-go#NotificationContent">NotificationContent</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
