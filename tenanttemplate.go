...
func (r *TenantTemplateService) Get(ctx context.Context, templateID string, query TenantTemplateGetParams, opts ...option.RequestOption) (res *TenantTemplateGetResponse, err error) {
...
type TenantTemplateGetResponse struct {
	// The template's id
...
func (r TenantTemplateGetResponse) RawJSON() string { return r.JSON.raw }
func (r *TenantTemplateGetResponse) UnmarshalJSON(data []byte) error {
